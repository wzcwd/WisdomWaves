  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        // login success, redirect to home page or other page
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4">
        ...
        <form className="w-full max-w-md flex flex-col gap-4" onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end">
            <Link href="#" className="text-[#3B6C8E] font-semibold text-sm hover:underline">Forgot Password?</Link>
          </div>
        ...
        <div className="mt-6 text-center text-[#232946] font-semibold">
          New to WisdomWaves?{' '}
          <Link href="/signup" className="text-[#3B6C8E] hover:underline">Sign up</Link>
        </div>
      </main>
    </div>
  );
